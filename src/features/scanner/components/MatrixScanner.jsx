...
import { getMinNotional } from '../../../shared/config/trading.js';
                ...
                <div className="flex items-center gap-3 w-full md:w-1/5">
                  ...
                  <div>
                    <div className="text-xs font-black text-white flex items-center gap-1">
                      {setup.symbol}
                      {(setup.strategyDisplayName || setup.overrideTag) && (
                      ...
                      {setup.executionMode === 'PAPER_ONLY' && (
                        <span className="text-[7px] font-black bg-amber-950/70 border border-amber-500/50 text-amber-300 px-1 rounded">
                          PAPER
                        </span>
                      )}
                    </div>
